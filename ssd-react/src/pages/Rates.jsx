...
export default function Rates() {
    ...
    if (!hasRole(['Super Admin', 'Finance'])) {
        return (
            <div className="rates-page flex items-center justify-center" style={{ minHeight: '80vh' }}>
                <Card>
                    <div style={{ textAlign: 'center', padding: 60, color: 'var(--text-muted)' }}>
                        ...
                        <p>This module contains sensitive labor and service rates restricted to Finance and Super Admin roles.</p>
                    </div>
                </Card>
            </div>
        );
    ...
    return (
        <GlobalLoadingOverlay loading={isLoading} message="Configuring Labor Rate Tables...">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setWrDaily(d);
                                        if (d) setWrHourly((parseFloat(d) / 8).toFixed(2));
                                    }}
                                />
                            </div>
                            <div className="form-group">
                                ...
                                <div className="rates-table">
                                    ...
                                    {workerRatesSorted.map((r) => (
                                        <div className="rates-table-row" key={r.id}>
                                            ...
                                            {editingId === r.id ? (
                                                <>
                                                    <span><input type="number" className="inline-edit" value={editData.hourlyRate} onChange={(e) => {
                                                        const h = e.target.value;
                                                        setEditData({ ...editData, hourlyRate: h, dailyRate: h ? (parseFloat(h) * 8).toFixed(2) : editData.dailyRate });
                                                    }} /></span>
                                                    <span><input type="number" className="inline-edit" value={editData.dailyRate} onChange={(e) => {
                                                        const d = e.target.value;
                                                        setEditData({ ...editData, dailyRate: d, hourlyRate: d ? (parseFloat(d) / 8).toFixed(2) : editData.hourlyRate });
                                                    }} /></span>
