...
import { Landmark, Plus, Search, Building, User, Truck, Pencil, Trash2, Shield } from 'lucide-react';
...
export default function BankAccounts() {
    ...
    if (!hasRole(['Super Admin', 'Finance'])) {
        return (
            <div className="bank-accounts-page flex items-center justify-center" style={{ minHeight: '80vh' }}>
                <Card>
                    <div style={{ textAlign: 'center', padding: 60, color: 'var(--text-muted)' }}>
                        ...
                        <p>This module contains sensitive financial and banking data restricted to Finance and Super Admin roles.</p>
                    </div>
                </Card>
            </div>
        );
    ...
    return (
        <GlobalLoadingOverlay loading={isLoading} message="Synchronizing Secure Banking Nodes...">
